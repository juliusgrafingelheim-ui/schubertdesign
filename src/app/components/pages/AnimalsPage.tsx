      ...
      <section className="py-24 md:py-32 bg-[#f8f7f5] px-4">
        <div className="max-w-5xl mx-auto">
          <SectionReveal>
            ...
            >
              {getText("packages_title", lang === "de" ? "Meine Pakete" : "My Packages")}
            </h2>
          </SectionReveal>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <SectionReveal>
            ...
            <button
              ...
              style={{ fontWeight: 400 }}
            >
              {getText("midcta_button", lang === "de" ? "Shooting anfragen" : "Inquire now")}
              <ArrowRight size={14} />
            </button>
          </SectionReveal>
        </div>
          ...
          <SectionReveal>
            <div className="text-center mb-16">
              <p
                ...
                style={{ fontWeight: 400 }}
              >
                {getText("tips_pretitle", lang === "de" ? "TIPPS" : "TIPS")}
              </p>
              <h2
                style={{
                  fontFamily: "'Cormorant Garamond', serif",
              ...
              >
                {getText("tips_title", lang === "de" ? "So bereitet ihr euch vor" : "How to prepare")}
              </h2>
            </div>
          </SectionReveal>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {(() => {
              const TipIcon1 = getIcon("tip1_icon", Heart);
              const TipIcon2 = getIcon("tip2_icon", Leaf);
              const TipIcon3 = getIcon("tip3_icon", Sun);
              const TipIcon4 = getIcon("tip4_icon", CameraIcon);
              return [
                { icon: TipIcon1, title: getText("tip1_title", lang === "de" ? "Geduld mitbringen" : "Be patient"), text: getText("tip1_text", lang === "de" ? "Tiere brauchen Zeit, um sich wohlzufühlen. Plant genug Puffer ein – Stress ist der größte Feind guter Bilder." : "Animals need time to feel comfortable. Plan enough buffer – stress is the enemy of great photos.") },
                { icon: TipIcon2, title: getText("tip2_title", lang === "de" ? "Lieblingsort wählen" : "Choose favorite spot"), text: getText("tip2_text", lang === "de" ? "Wo fühlt sich euer Tier am wohlsten? Der Lieblingspark, der Wald oder euer Garten – das merkt man an den Bildern." : "Where does your pet feel most at home? The favorite park, forest or your garden – it shows in the photos.") },
                { icon: TipIcon3, title: getText("tip3_title", lang === "de" ? "Goldene Stunde" : "Golden hour"), text: getText("tip3_text", lang === "de" ? "Das beste Licht gibt es morgens oder abends. Ich empfehle Shootings 1–2 Stunden vor Sonnenuntergang." : "The best light is in the morning or evening. I recommend shoots 1–2 hours before sunset.") },
                { icon: TipIcon4, title: getText("tip4_title", lang === "de" ? "Leckerlis nicht vergessen" : "Don't forget treats"), text: getText("tip4_text", lang === "de" ? "Kleine Belohnungen sorgen für Aufmerksamkeit und glückliche Gesichter – euer Tier wird es lieben." : "Small rewards ensure attention and happy faces – your pet will love it.") },
              ];
            })().map((tip, i) => (
